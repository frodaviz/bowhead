 ...
 * @author Vladimir Veta <veta90@gmail.com>
 */

namespace Bowhead\Util;

class BittrexAPIv2Exception extends \ErrorException
{
}

;

class BittrexAPIv2Client
{
    private $baseUrl;
    ...
    public function getLatestTick($market, $interval = "oneMin")
    {
        //interval is ["oneMin", "fiveMin", "thirtyMin", "hour", "day"]
        return $this->call('pub/market/GetLatestTick', array('marketName' => $market, "tickInterval" => $interval, "_" => time()));
    }

    //returns 10 days of ticks for 1 minute
    public function getTicks($market, $interval = "oneMin")
    {
//        echo time();
        //interval is ["oneMin", "fiveMin", "thirtyMin", "hour", "day"]
        return $this->call('pub/market/getTicks', array('marketName' => $market, "tickInterval" => $interval, "_" => time()));
    }
