...
//        $instruments = ['USDJPY','NZDUSD','EURGBP','USDCAD','USDCNH','USDMXN','USDTRY','AUDUSD','EURUSD','USDCHF'];
...
//        $instruments = ['BITTREX-USDT-XRP', 'BITTREX-USDT-NEO', 'BITTREX-USDT-OMG',
//            'BITTREX-USDT-ZEC', 'BITTREX-USDT-DASH', 'BITTREX-USDT-XMR'];
        ...
        while (1) {
            ...
            foreach ($instruments as $instrument) {
                ...
                $line .= $console->colorize(str_pad(" adx:$adx", 8), $this->doColor($adx));
                ...
                $line .= ($buy == 1 ? $console->colorize(' buy', 'light_green') : $sell == 1 ? $console->colorize(' sell', 'light_red') : ' ');
                echo "\n$line";
                /**
                 *  DISPLAY DONE
                 */
